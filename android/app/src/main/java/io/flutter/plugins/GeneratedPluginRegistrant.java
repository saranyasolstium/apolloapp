...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.freshchat.consumer.sdk.flutter.FreshchatSdkPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin freshchat_sdk, com.freshchat.consumer.sdk.flutter.FreshchatSdkPlugin", e);
    }
    try {
