...
class OralDetailScreen extends StatefulWidget {
  final int? id;
  final String? fromWhere;
  const OralDetailScreen({this.id, Key? key, this.fromWhere}) : super(key: key);

  @override
  State<OralDetailScreen> createState() => _OralDetailScreenState();
}

class _OralDetailScreenState extends State<OralDetailScreen> {
  final oralCtrl = Get.isRegistered<OralDetailController>()
      ? Get.find<OralDetailController>()
      : Get.put(OralDetailController());
  int? customerId;
  ...
  Future<void> fetchProductAvgRating() async {
    try {
      var response =
          await RemoteServices().fetchProductAvgRating(oralCtrl.oralID!);
      print(response.body);
  ...
  void _toggleColor() {
    ...
    if (_iconColor == Colors.red) {
      addToWishlist(oralCtrl.oralID!);
    } else {
      removeFromWishlist(oralCtrl.oralID!);
    }
  }
  ...
  Widget build(BuildContext context) {
    return GetBuilder<OralDetailController>(
        init: OralDetailController(),
        builder: (oralCtrl) {
          oralCtrl.productId = widget.id;
          return Scaffold(
              ...
              appBar: AppBar(
                ...
                actions: [
                  ...
                  //   showBadge: oralCtrl.myCartCount +
                  //           oralCtrl.myBookCount +
                  //           oralCtrl.myFrameCount +
                  //           oralCtrl.myAddOnCount >
                  //       0,
                  //   position: BadgePosition.topEnd(top: 0),
                  //   badgeContent: Text(
                  //     "${oralCtrl.myCartCount + oralCtrl.myBookCount + oralCtrl.myFrameCount + oralCtrl.myAddOnCount}",
                  //     style: zzRegularWhiteTextStyle12,
                  //   ),
                  //   child: InkWell(
                  //     onTap: () => Get.to(() => const Cart())!
                  //         .then((value) => oralCtrl.applyCartCount()),
                  //     child: SvgPicture.asset(
                  //       "assets/svg/cart.svg",
                  //       color: white,
                  //       height: 20.0,
              ...
              body: loading == true
                  ...
                  : SizedBox(
                      ...
                      child: Column(children: [
                                                  ...
                                                  children: [
                                                    ...
                                                    Row(
                                                      children: [
                                                        Text(
                                                          ...
                                                          '₹${oralCtrl.variantList.isEmpty ? "0" : oralCtrl.variantList[oralCtrl.mySelectedColorIndex]['price']}',
                                                          style:
                                                    ...
                                                    Visibility(
                                                        visible: oralCtrl.variantList[
                                                            ...
                                                            : true,
                                                        child: Text(
                                                            'Availability: ${oralCtrl.variantList[oralCtrl.mySelectedColorIndex]['inventory_quantity']} in stock',
                                                            style:
                                                                zzBoldBlueDarkTextStyle10B)),
                                                    const SizedBox(
                                                        height: 20.0),
                                                    oralCtrl.sizeName.isNotEmpty
                                                        ? Text(
                                                            'Size : ${oralCtrl.sizeName.first} ',
                                                    ...
                                                    Text(
                                                      'Color/Flavour : ${oralCtrl.selectedStyle}',
                                                      style: zzBoldBlueDarkTextStyle10B
                                                          .copyWith(
                                                              color:
                                                                  loginTextColor),
                        ...
                        Visibility(
                          visible: oralCtrl.fromWhere == 'CART' ? false : true,
                          child: Align(
                                        ...
                                        InkWell(
                                          onTap: () {
                                            sendMessageToWhatsApp(
                                                oralCtrl.clientMobileNumber
                                                    .toString(),
                                                context,
                                                'Product Title :${oralCtrl.productTitle}\nPrice :${oralCtrl.variantPrice}');
                                          },
                                          child: Column(
                                            mainAxisAlignment:
