...
class ClinicScreen2 extends StatefulWidget {
  const ClinicScreen2({Key? key}) : super(key: key);

  @override
  State<ClinicScreen2> createState() => _ClinicScreen2State();
}

class _ClinicScreen2State extends State<ClinicScreen2> {

List<ClinicModel> tamilList=[];
List<ClinicModel> telunganaList=[];
List<ClinicModel> karnatakaList=[];
List<ClinicModel> maharastraList=[];
...
List<ClinicModel> andhraPradeshList=[];
  ...
  void storeData(){
    ...
    //Tamilnadu
    model.id=1;
    model.clinicName='Apollo Clinic Kondapur';
    ...
    model.phone=0;
    model.address='Infinite Store, C/o Apollo clinic, Door No 11, 4, Sivaprakasam St, '
    ...
    model2.address='Apollo Clinic, Plot no:46, 7th street, Near Vijayanagar bus stand, Tansi nagar,Velachery, Chennai, Tamil Nadu, India ';
    tamilList.add(model2);

    ClinicModel model3= ClinicModel();
    model3.id=3;
    model3.clinicName='Anna Nagar';
    ...
    model3.address='Apollo Medical Centre, #30, F- Block, 2nd Avenue,Anna Nagar East, Chennai, Tamil Nadu, India';
    tamilList.add(model3);

    ClinicModel model4= ClinicModel();
    model4.id=4;
    model4.clinicName='Valasarivakkam';
    ...
    model4.address='1&2, Prakasam Rd, Near McDonald, Chowthri Nagar, Valasaravakkam, Chennai,Tamil Nadu';
    ...
    model5.address='PN 111, DN 7, Thirumalai nagar Annexe,OMR Perungudi,chennai';
    ...
    model6.address='Infinite Store, C/o Apollo Clinic, Gachibowli - Miyapur Rd RTC cross road, beside Swagth De-Royal Restaurants, Kothaguda, Hyderabad';
    telunganaList.add(model6);
    ...
    model7.phone=7075170714;
    model7.address='	Infinite store, C/o Apollo Clinic,H No.1-58/91,Suresh Square,Seri Mandal, Chandanagar, Hyderabad';
    telunganaList.add(model7);
    ...
    model8.phone=7207955889;
    model8.address='Infinite Store, C/o Apollo Clinic, # 239, Ground Floor, Near Bhavyas Anandam Apartments, Nizampet , Hyderabad, Telangana';
    telunganaList.add(model8);

    ClinicModel model9= ClinicModel();
    model9.id=9;
    model9.clinicName='Apollo clinic Manikonda';
    model9.state='Telungana';
    model9.city='Manikonda';
    model9.pincode=500089;
    model9.latitude=17.40597;
    model9.longitude=78.392148;
    model9.phone=9154978509;
    model9.address='Infinite Store, C/o Apollo Clinic, #284, Shaikpet Main Rd, near Bhema Restaurant, OU Colony, Shaikpet, Manikonda, Telangana';

    telunganaList.add(model9);
    ...
    model10.address='Infinite Store, C/o Apollo Clinic, Rishab heights, above vodafone store, beside KFC, Trimulgherry - ECIL Rd, A. S. Rao Nagar, Secunderabad, Telangana';

    telunganaList.add(model10);
    ClinicModel model11= ClinicModel();
    model11.id=11;
    model11.clinicName='J.H Pharmacy';
    model11.state='Telungana';
    model11.city='Hyderabad';
    model11.pincode=500033;
    model11.latitude=17.42952228;
    model11.longitude=78.40965672;
    model11.phone=9154995204;
    model11.address='Apollo pharmacy Rd Number 59, beside Farzi Cafe, Jubilee Hills, Hyderabad, Telangana';

    telunganaList.add(model11);
    ClinicModel model12= ClinicModel();
    model12.id=12;
    model12.clinicName='JH';
    model12.state='Telungana';
    model12.city='Hyderabad';
    model12.pincode=500033;
    model12.latitude=17.415096;
    model12.longitude=78.4128;
    model12.phone=7207955426;
    model12.address='	Film Nagar, Jubilee Hills, Hyderabad, Telangana';

    telunganaList.add(model12);
    ClinicModel model13= ClinicModel();
    model13.id=13;
    model13.clinicName='Secunderabad';
    ...
    model13.address="Pollicetty Towers, St. John's Road, beside Keyes High School, Secunderabad, Telangana";
    telunganaList.add(model13);


    ClinicModel model14= ClinicModel();
    model14.id=14;
    model14.clinicName='Vizag (Health City)';
    ...
    model14.address='Plot No:1, Arilova, Chinagadali';
    telunganaList.add(model14);

    ClinicModel model15= ClinicModel();

    model15.id=15;
    model15.clinicName='Hyderguda';
    model15.state='Telangana';
    model15.city='Hyderabad';
    model15.pincode=500029;
    model15.latitude=17.40597;
    model15.longitude=78.479185;
    model15.phone=9154978506;
    model15.address='Near, Plot No. 3-5-836 to 838, Hyderguda-Basheerbagh Rd, Old MLA Quarters, King Koti';

    telunganaList.add(model15);
  //Karnataka
    ...
    model16.address='Infinite store, Apollo Clinic, Bellandur, 74/1, Service Rd, Near Soul Space Spirit Central Mall, Bellandur, Bengaluru, Karnataka – 560103';
    ...
    model17.address='Infinite Store, C/o Apollo clinic, Audiology department, 1st floor, 54, 12th Main Rd, above SBI Bank, HSR Layout, Bengaluru, Karnataka 560102';
    ...
    model18.address='	Infinite Store, C/o Apollo clinic, 1st floor, plot 2012, 100 Feet Rd, next to Starbucks, Above Vision Express India, HAL 2nd Stage, Indiranagar, Bengaluru, Karnataka 560038';
    ...
    model19.phone=0;
    model19.address='	Infinite Store, C/o Apollo Clinic, Room no 22 BNR complex, Near, Brigade Millenium Rd, Puttenahalli, JP Nagar 7th Phase, J. P. Nagar, Bengaluru, Karnataka 560078';
    ...
    model20.address='	Infinite Store, C/o Apollo Clinic ,, Neeladri Rd, Karuna Nagar,Electronics City Phase 1, Electronic City, Bengaluru, Karnataka 560100';
    ...
    model21.address='Infinite Store, C/o Apollo Clinic #23, Panchavati Circle, Kalidasa Rd, Vani Vilas Mohalla, Mysuru, Karnataka 570002';

    karnatakaList.add(model21);
    ...
    model22.address='Infinite Store, C/o Apollo Clinic, 673/A,Shriram Samruddhi Apartments, Varthur Road, Near Kundalahalli Signal, Whitefield, BEML Layout, Brookefield, Bengaluru, Karnataka 560066';
    ...
    model23.address='Old No. 28, 1, Platform Rd, Near Mantri Square Mall, Seshadripuram,Bengaluru, Karnataka';
    ...
    model24.address='Adichunchanagiri Road, Jayanagar, Kuvempu Nagara';
      karnatakaList.add(model24);
    ...
    model25.address='Infinite Store, C/o Apollo Clinic, Audiology department, #102,B Wing, 1st Floor, Kul Scapes, Magarpatta Road, '
        'Opp. Reliance Smart, Kharadi, Pune, Maharashtra 411014';

    maharastraList.add(model25);
    ...
    model26.address='Infinite Store, C/oApollo Clinic Ground Nyati Millenium Premises S1 Datta Mandir Chowk, Viman Nagar, Pune, Maharashtra 411014';

    maharastraList.add(model26);
    ...
    model27.address='Infinite Store, C/o Apollo Clinic, Plot no B-1, Amba Vatika Co-op Housing society, near Café Coffee Day, Khondawa Khurd, Pune, Maharashtra 411048';

    maharastraList.add(model27);
    ...
    model28.address='Infinite Store, C/o Apollo Clinic, Shop # 14 -20, City Pride building ,Below kotak mahindra bank Next to, Sant Dyaneshwar Chowk, Nigdi, Pune, Maharashtra 411044';

    maharastraList.add(model28);
    ...
    model29.address='Infinite Store, C/o Apollo Clinic,Centriole Building, 130, ITI Road, Above Star Bucks Coffee,Anand Park, Aundh, PUNE – 411 007, Maharashtra State, India';

    maharastraList.add(model29);
    ...
    model30.address='lot # 13, Off Uran Road, Parsik Hill Rd, Sector 23, CBD Belapur';

    maharastraList.add(model30);
    ...
    model31.address='Plot No. 1, Swaminarayan Nagar, New Adgaon Naka, Panchavati, near Lunge Mangal Karyalay, Nashik, Maharashtra';

    maharastraList.add(model31);
    //Madhya Pradesh
    ...
    model32.address='Shop No 5 NAVKAR SQUARE, TEEN BATTI CHOURAHA,Free ganj,Ujjain';
    ...
    model33.address='Sho no LG 3, 213-214 Lakshya Square,Infront of queens college, Khandwa Road, Ranibagh';
    mathyaPradeshList.add(model33);
    ...
    model34.address='Hno:166,purana,AB road,Kishanganj,Infront of SBI kishanganj';

    mathyaPradeshList.add(model34);
    //Andhra Pradesh
    ClinicModel model35= ClinicModel();
    model35.id=35;
    model35.clinicName='Apollo Hospital Ramnagar Viz';
    ...
    model35.address='10-50-80, Waltair Main Road';
    andhraPradeshList.add(model35);

  }
  void getList(){
    debugPrint('TAMIL NADU LIST SIZE:: ${tamilList.length}');
    debugPrint('KARNATAKA LIST SIZE:: $karnatakaList');
    debugPrint('TELUNGANA LIST SIZE:: $telunganaList');
    debugPrint('MAHARASTRA LIST SIZE:: $maharastraList');
    debugPrint('MATHYA PRADESH LIST SIZE:: $mathyaPradeshList');
    debugPrint('ANDHRA PRADESH LIST SIZE:: $andhraPradeshList');
  }
}
